...
trait SegmentCodec[A]:
  ...
  final def imap[B]( f: A => B )( g: B => A ): SegmentCodec[B] =
    new SegmentCodec[B]:
  ...
  final def imapFilter[B]( f: A => Option[B] )( g: B => A ): SegmentCodec[B] =
    new SegmentCodec[B]:
...
object SegmentCodec:
  ...
  def enumSegment[E]( E: CustomEnum[E] ): SegmentCodec[E] = String.imapFilter( E.withNameOption )( E.keyOf )
