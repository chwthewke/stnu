...
trait BulmaClasses[A]:
  ...
  //  half-int gaps
  val `isGap0.5`: A = cls( "is-gap-0.5" )
  val `isColumnGap0.5`: A = cls( "is-column-gap-0.5" )
  val `isRowGap0.5`: A = cls( "is-row-gap-0.5" )
  val `isGap1.5`: A = cls( "is-gap-1.5" )
  val `isColumnGap1.5`: A = cls( "is-column-gap-1.5" )
  val `isRowGap1.5`: A = cls( "is-row-gap-1.5" )
  val `isGap2.5`: A = cls( "is-gap-2.5" )
  val `isColumnGap2.5`: A = cls( "is-column-gap-2.5" )
  val `isRowGap2.5`: A = cls( "is-row-gap-2.5" )
  val `isGap3.5`: A = cls( "is-gap-3.5" )
  val `isColumnGap3.5`: A = cls( "is-column-gap-3.5" )
  val `isRowGap3.5`: A = cls( "is-row-gap-3.5" )
  val `isGap4.5`: A = cls( "is-gap-4.5" )
  val `isColumnGap4.5`: A = cls( "is-column-gap-4.5" )
  val `isRowGap4.5`: A = cls( "is-row-gap-4.5" )
  val `isGap5.5`: A = cls( "is-gap-5.5" )
  val `isColumnGap5.5`: A = cls( "is-column-gap-5.5" )
  val `isRowGap5.5`: A = cls( "is-row-gap-5.5" )
  val `isGap6.5`: A = cls( "is-gap-6.5" )
  val `isColumnGap6.5`: A = cls( "is-column-gap-6.5" )
  val `isRowGap6.5`: A = cls( "is-row-gap-6.5" )
  val `isGap7.5`: A = cls( "is-gap-7.5" )
  val `isColumnGap7.5`: A = cls( "is-column-gap-7.5" )
  val `isRowGap7.5`: A = cls( "is-row-gap-7.5" )
  //  Fixed Grid
